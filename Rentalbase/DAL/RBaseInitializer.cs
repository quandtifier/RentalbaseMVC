        ...
        protected override void Seed(RBaseContext context)
        {
            ...
            var leases = new List<Lease>
            {
                new Lease { Tenants = new List<Tenant>(),
                    LeaseID =1, PropertyID=1, StartDate=DateTime.Parse("2010-01-01"), EndDate=DateTime.Parse("2011-01-01"), RateMonthly=2000},
                new Lease { Tenants = new List<Tenant>(),
                    LeaseID =2, PropertyID=1, StartDate=DateTime.Parse("2012-02-01"), EndDate=DateTime.Parse("2012-01-01"), RateMonthly=2000},
                new Lease { Tenants = new List<Tenant>(),
                   LeaseID =3, PropertyID=1, StartDate=DateTime.Parse("2010-10-01"), EndDate=DateTime.Parse("2010-06-01"), RateMonthly=2000},
            };
            ...
            var invoices = new List<Invoice>
            {
                ...
                new Invoice {PropertyID=3, DateIssued=DateTime.Parse("2017-05-23"), DatePaid=DateTime.Parse("2018-01-02"), Description="Rent Payment", Cost=2000.00M, InvoiceType = invTypes.SingleOrDefault(t => t.Type == "DAMAGE") },
            };
