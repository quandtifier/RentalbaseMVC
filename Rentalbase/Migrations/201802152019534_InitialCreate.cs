namespace Rentalbase.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.LeaseTenant", "TenantID", "dbo.Tenant");
            DropForeignKey("dbo.LeaseTenant", "LeaseID", "dbo.Lease");
            ...
            DropIndex("dbo.LeaseTenant", new[] { "TenantID" });
            DropIndex("dbo.LeaseTenant", new[] { "LeaseID" });
